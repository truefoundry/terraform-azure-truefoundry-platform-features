...
output "platform_blob_storage_enabled" {
...
output "platform_container_registry_enabled" {
  value = var.platform_feature_enabled && var.feature_container_registry_enabled
  description = "Container registry feature enabled"
}
