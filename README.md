...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_integrations"></a> [integrations](#module\_integrations) | git::https://github.com/truefoundry/terraform-truefoundry-integrations.git | v0.1.0-rc.2 |
...
| <a name="input_blob_storage_account_connection_string"></a> [blob\_storage\_account\_connection\_string](#input\_blob\_storage\_account\_connection\_string) | Connection string of the storage account | `string` | n/a | yes |
...
| <a name="input_blob_storage_account_root_url"></a> [blob\_storage\_account\_root\_url](#input\_blob\_storage\_account\_root\_url) | Root URL of the storage account | `string` | n/a | yes |
...
| <a name="input_cluster_integration_enabled"></a> [cluster\_integration\_enabled](#input\_cluster\_integration\_enabled) | Enable cluster integration | `bool` | `false` | no |
...
| <a name="input_container_registry_admin_password"></a> [container\_registry\_admin\_password](#input\_container\_registry\_admin\_password) | Password for the admin user of the container registry | `string` | n/a | yes |
| <a name="input_container_registry_admin_username"></a> [container\_registry\_admin\_username](#input\_container\_registry\_admin\_username) | Username for the admin user of the container registry | `string` | n/a | yes |
...
| <a name="input_control_plane_url"></a> [control\_plane\_url](#input\_control\_plane\_url) | Control plane URL | `string` | n/a | yes |
...
| Name | Description |
|------|-------------|
| <a name="output_platform_blob_storage_enabled"></a> [platform\_blob\_storage\_enabled](#output\_platform\_blob\_storage\_enabled) | Blob storage feature enabled |
| <a name="output_platform_container_registry_enabled"></a> [platform\_container\_registry\_enabled](#output\_platform\_container\_registry\_enabled) | Container registry feature enabled |
...
| <a name="output_truefoundry_cluster_integrations_enabled"></a> [truefoundry\_cluster\_integrations\_enabled](#output\_truefoundry\_cluster\_integrations\_enabled) | Cluster integration feature enabled |
